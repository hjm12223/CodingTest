...
public class lottoHighRank {
    public static void main(String[] args) {
        int[] solution = solution(new int[]{44, 1, 0, 0, 31, 25}, new int[]{31, 10, 45, 1, 6, 19});
        int[] solution1 = solution(new int[]{1, 2, 3, 4, 5, 0}, new int[]{7, 8, 9, 10, 11, 12});
    ...
    public static int[] solution(int[] lottos, int[] win_nums) {
        ...
        if (minResult >= 6) {
            return new int[]{cnt + 1, 6};
        } else {
            return new int[]{cnt + 1, minResult + 1};
        }
    }
}
/**
